/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/Users/build/workspace/GCC-5-build_build-toolchain-mac/gcc-arm-none-eabi-5_4-2016q3-20160926/src/gcc/gcc/config/arm/arm.md'.  */
