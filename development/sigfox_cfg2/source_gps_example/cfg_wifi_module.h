...
#define CWIFI_AT_CMD_SIZE_MAX 64
#define CWIFI_AT_CMD_RESP_PACKET_MAX 63  // & 0x3F : 6bit max value

#define CWIFI_BYPASS_BUF_SIZE 512
...
#define CWIFI_SPI_ISR_CLEAR_WAIT_TIMEOUT_TICK 3
#define CWIFI_SPI_INTERRUPT_CLEAR_WAIT_TIME_MS 20

#define CWIFI_SPI_CMD_RESP_TIME_OUT_TICK_LONG 100  //for first response time out tick
#define CWIFI_SPI_CMD_RESP_WAIT_TIME_MS_LONG 100  //for first response time out time
#define CWIFI_SPI_CMD_RESP_TIME_OUT_TICK 10
#define CWIFI_SPI_CMD_RESP_WAIT_TIME_MS 20
